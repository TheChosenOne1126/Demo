...
namespace GlobalTags
{
	...
	DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AbilitySlotInitTag)
	DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AbilityGivenTag)
	DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AbilityUltimateTag)
	DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AbilitySlotTag)
	DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AbilityInputPressTag)
	DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(AbilityInputReleaseTag)
	...
	DEMO_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(EffectCoolDownTag)
}